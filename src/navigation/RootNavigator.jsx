...
//import type { RootStackParamList } from './types';  <Stack.Screen name="loader" component={LoaderScreen} />
...
export function RootNavigator() {
  ...
  const INITIAL_URL = `https://bright-node-digital.site/`;
  const URL_IDENTIFAIRE = `vB3DAKXQ`;
  ...
  OneSignal.initialize('9c298a6a-4484-445e-8574-647b3864034f');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-21T08:08:00'); //дата з якої поч працювати webView
